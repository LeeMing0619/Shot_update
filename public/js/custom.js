...
jQuery(document).ready(function () {
  ...
  $(".tab").on("click", function (evt) {
    ...
    var togglesel = this.getAttribute("data-toggle-target");
    $(".tab-content").removeClass("active").filter(togglesel).addClass("active");
    // $(".tab").removeClass("active").filter(sel).addClass("active");
    var csssel = this.getAttribute("id");
    $("#"+csssel).css("background-color","#e1e7ff");
    $("#"+csssel).css("color","#37a000");
    for(i=1;i<=6;i++){
      if("tab"+i != csssel){
        $("#tab"+i).css("background-color","white");
        $("#tab"+i).css("color","#777777");
      }        
    }
  });
});
